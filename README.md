...
Features: quick pairing + custom seeks (time, walled variant, colour), challenge-a-friend links, server clocks w/ low-time cues,
takeback / draw / resign / abort / +15s, rematch, chat, spectating + watcher count, TV, opponent-gone claim, accounts + Glicko-2,
profiles w/ rating chart, head-to-head crosstable, leaderboard, analysis board with branching, play vs computer (4 levels, in a worker),
move list w/ keyboard nav, zen mode, board colour themes, sounds, desktop notifications, mobile layout.
